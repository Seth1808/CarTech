...
/**
 * Servlet implementation class ContactregServlet
 */
@WebServlet("/ContactregServlet")
public class ContactregServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
		 ...
		 "jdbc:mysql://localhost:3306/contactdetails", "root", "");
		...
		writer.println("<h1>" + "You have successfully registered an contact detail!" +
		"</h1>");
		writer.close();
		}
		}
